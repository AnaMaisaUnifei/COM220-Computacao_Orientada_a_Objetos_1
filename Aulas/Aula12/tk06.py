...
class GUI:
   def __init__(self):
      ...
      self.labelInfo1 = tk.Label(self.frame1,text="Digite algo 1:")
      self.labelInfo2 = tk.Label(self.frame2,text="Digite algo 2:")
   ...
   def submit(self):
      ...
      if (self.labelResult1["text"] == ""):
         self.labelResult1["text"] = "Nada"
      
      if (self.labelResult2["text"] == ""):
